...
public class CachingInvocationHandlerFactory implements InvocationHandlerFactory {
     ...
     */
    public CachingInvocationHandlerFactory(InvocationHandlerFactory decorated, CacheStrategy<InvocationCacheKey, Object> cacheStrategy) {
     ...
     */
    @Override
    public CachingInvocationHandler create(Class<?> proxyInterface, Resolver rootResolver, Converter<?> rootConverter, VariableExpander variableExpander, InvocationContextFactory invocationContextFactory) {
