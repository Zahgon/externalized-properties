...
public class CachingInvocationHandler implements InvocationHandler {
     ...
     */
    public CachingInvocationHandler(InvocationHandler decorated, CacheStrategy<InvocationCacheKey, Object> cacheStrategy) {
    ...
    private Object getAndCache(InvocationCacheKey cacheKey, Object proxy, Method method, Object[] args) {
        try {
            ...
            throw new ExternalizedPropertiesException("Error occurred while invoking decorated invocation handler.", e);
        }
    }
}
