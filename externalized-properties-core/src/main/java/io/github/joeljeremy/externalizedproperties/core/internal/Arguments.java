...
public class Arguments {
     ...
     */
    public static <T> Collection<T> requireNonNullOrEmpty(@Nullable Collection<T> arg, String argName) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @return The {@link Collection} argument.
     */
    public static <T> Collection<T> requireNoNullElements(@Nullable Collection<T> arg, String argName) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
