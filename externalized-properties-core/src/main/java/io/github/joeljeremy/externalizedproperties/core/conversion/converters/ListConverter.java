...
public class ListConverter implements Converter<List<?>> {
     ...
     */
    @Override
    public ConversionResult<List<?>> convert(InvocationContext context, String valueToConvert, Type targetType) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
    ...
    private List<Object> newList(int capacity) {
        ...
        if (list == null || !list.isEmpty()) {
            throw new IllegalStateException("List factory implementation must not return null or a populated list.");
        }
        return list;
    }
