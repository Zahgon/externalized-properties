...
public class MapResolver implements Resolver {
     ...
     *     discarded.
     */
    public MapResolver(Map<String, String> propertySource, UnresolvedPropertyHandler unresolvedPropertyHandler) {
        // Copy.
        this.propertySource = new ConcurrentHashMap<>(requireNonNull(propertySource, "propertySource"));
        this.unresolvedPropertyHandler = requireNonNull(unresolvedPropertyHandler, "unresolvedPropertyHandler");
    }
    ...
    public static interface UnresolvedPropertyHandler {
         ...
         */
        @Nullable
        String handle(String unresolvedPropertyName);
    }
}
