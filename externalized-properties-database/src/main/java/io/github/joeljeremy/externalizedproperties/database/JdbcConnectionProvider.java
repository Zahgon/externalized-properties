...
public class JdbcConnectionProvider implements ConnectionProvider {
     ...
     *     DataSource}.
     */
    public JdbcConnectionProvider(DataSource dataSource, @Nullable String username, @Nullable String password) {
        if (dataSource == null) {
            throw new IllegalArgumentException("dataSource must not be null.");
        }
     ...
     */
    public JdbcConnectionProvider(String jdbcConnectionString, @Nullable String username, @Nullable String password) {
        if (jdbcConnectionString == null) {
            throw new IllegalArgumentException("jdbcConnectionString must not be null.");
        }
