...
public class SimpleNameValueQueryExecutor extends AbstractNameValueQueryExecutor {
    ...
    private static final String SCHEMA_SYSTEM_PROPERTY = SimpleNameValueQueryExecutor.class.getName() + ".schema";

    private static final String TABLE_SYSTEM_PROPERTY = SimpleNameValueQueryExecutor.class.getName() + ".table";

    private static final String PROPERTY_NAME_COLUMN_SYSTEM_PROPERTY = SimpleNameValueQueryExecutor.class.getName() + ".propertyNameColumn";

    private static final String PROPERTY_VALUE_COLUMN_SYSTEM_PROPERTY = SimpleNameValueQueryExecutor.class.getName() + ".propertyValueColumn";
     ...
     * system property.
     */
    public static final String DEFAULT_TABLE = System.getProperty(TABLE_SYSTEM_PROPERTY, "externalized_properties");
     ...
     */
    public static final String DEFAULT_PROPERTY_NAME_COLUMN = System.getProperty(PROPERTY_NAME_COLUMN_SYSTEM_PROPERTY, "property_name");
     ...
     */
    public static final String DEFAULT_PROPERTY_VALUE_COLUMN = System.getProperty(PROPERTY_VALUE_COLUMN_SYSTEM_PROPERTY, "property_value");
    ...
    public SimpleNameValueQueryExecutor() {
        this(DEFAULT_SCHEMA, DEFAULT_TABLE, DEFAULT_PROPERTY_NAME_COLUMN, DEFAULT_PROPERTY_VALUE_COLUMN);
    }
     ...
     */
    public SimpleNameValueQueryExecutor(String schema, String table, String propertyNameColumn, String propertyValueColumn) {
        if (schema == null) {
